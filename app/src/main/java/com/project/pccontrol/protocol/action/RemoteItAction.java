package com.project.pccontrol.protocol.action;
...
public abstract class RemoteItAction
{
	...
	public static RemoteItAction parse(DataInputStream dis, byte type) throws IOException
	{
		// byte type = dis.readByte();
